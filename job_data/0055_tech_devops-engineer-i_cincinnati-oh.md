...
**Location:** Cincinnati, OH, US (Hybrid)
**Salary:** $63,000 - $80,000/year
...
## About the Role
We're seeking a DevOps Engineer I to join our E-Signature team in Cincinnati. This role offers the opportunity to contribute meaningfully to our mission while developing your professional skills in a collaborative environment. You'll work with talented colleagues dedicated to excellence and innovation in our field.
...
- **Experience:** 1-3 years in DevOps, Cloud Operations, or Systems Engineering
- **Skills:** Linux/Unix administration, Docker/Kubernetes, Infrastructure as Code (Terraform), Cloud platforms (AWS/Azure/GCP), Python/Bash scripting
